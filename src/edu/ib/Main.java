...
public class Main {
    public static void main(String[] args) {
        ...
        double xStop = solver.integrate((t, x)->4*Math.exp(0.8*t)-0.5*x,0,1,4, 50);
        ...
        double xStop1=solver1.integrate((t, x)->4*Math.exp(0.8*t)-0.5*x,0,1,4, 50);
        ...
        double xStop2=solver2.integrate((t, x)->4*Math.exp(0.8*t)-0.5*x,0,1,4, 50);
        ...
        double xStop3 = solver3.integrate((t, x)->4*Math.exp(0.8*t)-0.5*x,0,1,4, 50);
        ...
        double xStop4=solver4.integrate((t, x)->4*Math.exp(0.8*t)-0.5*x,0,1,4, 50);
        ...
        double xStop5=solver5.integrate((t, x)->4*Math.exp(0.8*t)-0.5*x,4,1,9, 10);
